...
Patil's Editor (formerly HyperEdit / ClipWise) is an AI-powered video editor built with React 19, Remotion for motion graphics, and Cloudflare Workers for the backend. Uses DeepSeek for all AI tasks and fal.ai/FLUX.1 schnell for image generation.
